...
def SSD(input_shape, num_classes):
    ...
    FeatureExtractor=Model(inputs=mobilenetv2.input, outputs=mobilenetv2.get_layer(name='res_connect_' + str(12)).output)
...
print(SSD(input_shape=(300,300,3), num_classes=21).summary())